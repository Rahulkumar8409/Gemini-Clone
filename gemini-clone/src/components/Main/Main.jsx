  ...
  return (
    <div className="main">
      ...
      <div className="main-container">
        ...
        <div className="cards">
          <div className="card">
            <p>Suggest beautifil place to see on a an upcoming road trip</p>
          ...
          <div className="card">
            <p>Brainstorn team bonding activites for our work retreat</p>
        ...
        <p className="botton-info">
          Gemini may display inaccurate info, including about people , so double-cheak its responses.Your Privacy and Gemini Apps
        </p>
        </div>
      </div>
    </div>
